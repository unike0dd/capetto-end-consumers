const CSP = "default-src 'self'; img-src 'self' https://unike0dd.github.io data:; connect-src 'self' https://unike0dd.github.io; script-src 'self'; style-src 'self'; font-src 'self'; object-src 'none'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'; frame-src 'none'; upgrade-insecure-requests; report-to csp-endpoint";
