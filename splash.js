(()=>{
  ...
  const name=sessionStorage.getItem("cappeto_consumer_name")||"Consumer";
  ...
  let selectedLanguage=window.CappetoI18n.language==="es"?"es":"en";
  ...
  languageButton.addEventListener("click",()=>{selectedLanguage=selectedLanguage==="en"?"es":"en";window.CappetoI18n.setLanguage(selectedLanguage);translate()});
  themeButton.addEventListener("click",()=>{selectedTheme=selectedTheme==="light"?"dark":"light";window.CappetoI18n.setTheme(selectedTheme);translate()});
