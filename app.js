...
const copy={en:{eyebrow:"YOUR LOCAL FOOD BUSINESS",yourOrder:"YOUR ORDER",bagTitle:"Your bag",subtotal:"Subtotal",vat:"VAT",delivery:"Delivery",total:"Total",checkout:"Continue to checkout",footer:"Freshly prepared local favorites.",available:"available",add:"Add",empty:"No products match your search.",added:"Added to your bag",emptyBag:"Your bag is ready for something delicious.",checkoutMsg:"Checkout connection is the next step."},es:{eyebrow:"TU NEGOCIO LOCAL DE ALIMENTOS",yourOrder:"TU PEDIDO",bagTitle:"Tu bolsa",subtotal:"Subtotal",vat:"IVA",delivery:"Entrega",total:"Total",checkout:"Continuar al pago",footer:"Favoritos locales recién preparados.",available:"disponibles",add:"Agregar",empty:"Ningún producto coincide con tu búsqueda.",added:"Agregado a tu bolsa",emptyBag:"Tu bolsa está lista para algo delicioso.",checkoutMsg:"La conexión de pago es el siguiente paso."}};
